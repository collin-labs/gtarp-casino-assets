  ...
  return (
    ...
    >
      ...
      {items.map((game, idx) => {
        ...
        /* Daily Free (id 19) usa logo hero */
        const useHeroLogo = game.id === 19;
        const logoSrc = useHeroLogo
          ? (isBR
            ? "/assets/logos-br-para-hero/GTARP CASINO LOGOS (BR)/19.LOGO-BR-DAILY-FREE.png"
            : "/assets/logos-in-para-hero/GTARP CASINO LOGOS (IN)/19.LOGO-IN-DAILY-FREE.png")
          : (isBR ? game.logoBR : game.logoIN);
        ...
        return (
          ...
          >
            {/* O GameCard base — pointer-events desabilitado pra
                evitar hover duplo; o wrapper já faz hover */}
