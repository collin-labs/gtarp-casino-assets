        ...
        >
          <motion.div
            ...
            style={{
              ...
              background: "#1A1A1A", border: "1px solid #D4A843", borderRadius: "12px",
              padding: "clamp(16px, 2vw, 28px)",
              boxShadow: "0 0 30px rgba(212,168,67,0.2), 0 8px 30px rgba(0,0,0,0.6)",
          ...
          >
            ...
            <div style={{
              ...
              {isBR ? "Custo:" : "Cost:"} R$ {cost.toFixed(2).replace(".", ",")}
            </div>
            ...
            <span style={{
              ...
              ({costMultiplier}x {isBR ? "sua aposta de" : "your bet of"} R$ {betAmount.toFixed(2).replace(".", ",")})
            </span>
